...
<html>
<head>
<title>Inscription des modérateurs</title>
          ...
          if(isset($_POST['inscription']))
              {
                  ...
                  /*email unique */
                  $req = $connexion->prepare("SELECT * FROM moderateur WHERE email=?");
                        ...
                        if($number){
                          if($symbol){
                            if(strlen($_POST['password']) > 8){
                              ...
                              {
                                  $stmt = $connexion->prepare("INSERT INTO `moderateur`(`id_mod`, `nom`, `prenom`, `tel`, `email`, `passwords`) VALUES (:id, :nom, :prenom, :tel, :mail, :pass_hash)");
                                  ...
                                  $Session2->setFlash("Vous venez de vous inscrire en tant que modérateur !", 'succes');
         ...
         }else
           {
             ...
             $Session9->setFlash("Le nombre de compte modérateur autorisé est atteint(2 maximum)",'error');
             $Session9->flash_danger();
           }
            ?>
      </form>
  </div>

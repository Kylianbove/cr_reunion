...
if(isset($_GET['id'])){
$query_rs_utiles = $connexion->prepare("SELECT * FROM audio WHERE id_audio=?");
...
$query_rs_content = $connexion->prepare("SELECT * FROM audio ORDER BY id_audio ASC");
                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Audio <a href="audio.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="audio.php?id=<?php echo $row_rs_content['id_audio']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="audio.php?supprimer=<?php echo $row_rs_content['id_audio']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM audio WHERE id_audio=?");
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier un Audio</h3>
                                    ...
                                    <div class="form-group">
                                    <label for="fichier">Audio (format autorisé: mp3)</label>
                                    <input type="file" id="fichier" name="fichier" value="<?php echo $row_rs_utiles['fichier']; ?>"></br>
                                    <audio src="./fichiers/audios/<?php echo $row_rs_utiles['fichier']; ?>" controls width='320px' height='200px'>
                                    </div></br>
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            if( in_array($videoFileType,$extensions_arr) ){
                                              ...
                                              if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                                ...
                                                if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE audio SET id_actu=:id_actu, titre=:titre, fichier=:fichier, publier=:publier WHERE id_audio='".$_GET['id']."'");
                                                ...
                                                $Session14->flash_danger();
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE audio SET id_actu=:id_actu, titre=:titre, publier=:publier WHERE id_audio='".$_GET['id']."'");
                                     ...
                                     <a href="audio.php" class="btn btn-warning">Retour à la liste</a>
                                        ...
                                        if( in_array($videoFileType,$extensions_arr) ){
                                          ...
                                          if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                            ...
                                            if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                              ...
                                              $insertSQL = $connexion->prepare("INSERT INTO `audio`(`id_audio`, `id_actu`, `titre`, `fichier`, `publier`) VALUES (:id_audio, :id_actu, :titre, :fichier, :publier)");

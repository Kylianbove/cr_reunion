                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Audio <a href="audio.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="audio.php?id=<?php echo $row_rs_content['id_audio']; ?>">Modif.</a>  |
                                      <a href="audio.php?supprimer=<?php echo $row_rs_content['id_audio']; ?>">Suppr.</a>
                                    </td>

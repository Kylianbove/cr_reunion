...
$query_rs_content = $connexion->prepare("SELECT * FROM contributeur ORDER BY id_contri ASC");
                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone contributeur <a href="contributeur.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="contributeur.php?id=<?php echo $row_rs_content['id_contri']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="contributeur.php?supprimer=<?php echo $row_rs_content['id_contri']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                    ...
                                    <?php
                                    $usersphoto = $connexion->prepare("SELECT * FROM contributeur WHERE photo = '".$row_rs_content['photo']."'");
                                    $usersphoto->execute();
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM contributeur WHERE id_contri=?");
                                      $req->execute(array($_GET['supprimer']));
                                      $Session12 = new Session();
                                      $Session12->setFlash("Vous venez de supprimer un contributeur",'error');
                                      $Session12->flash_danger();
                                      $insertGoTo = "contributeur.php?OK";
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier un compte Contributeur</h3>
                                    <div class="graph-form">
                                  ...
                                  -->
                                  <div class="form-group">
                                    <label for="actif"  style="float:left;width:200px!important;">Contributeur Actif</label>
                                                ...
                                                if(strlen($_POST['password']) > 8){
                                                  if($row_rs_utiles['photo'] != null){
                                                    if($_POST['couleur'] != $row_rs_utiles['couleur']){
                                                      $updatephoto = $connexion->prepare("UPDATE contributeur SET photo = null WHERE id_contri='".$_GET['id']."'");
                                                      $updatephoto->execute();
                                                    }
                                                  }
                                                    ...
                                                    if( in_array($videoFileType,$extensions_arr) ){
                                                      ...
                                                      if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                                        ...
                                                        if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                                          $updateSQL = $connexion->prepare("UPDATE contributeur SET nom=:nom, prenom=:prenom, tel=:tel, email=:email, passwords=:pass_hash, actif=:actif, photo=:photo WHERE id_contri='".$_GET['id']."'");
                                                      ...
                                                      $updateSQL = $connexion->prepare("UPDATE contributeur SET nom=:nom, prenom=:prenom, tel=:tel, email=:email, passwords=:pass_hash, actif=:actif, couleur=:couleur WHERE id_contri='".$_GET['id']."'");
                                                      if($_POST['password'] != $row_rs_utiles['passwords']){
                                                      $pass_hash = password_hash($_POST['password'], PASSWORD_DEFAULT); //Hash mdp
                                                      }else{
                                                        $pass_hash = $_POST['password'];
                          ...
                          }else
                          {
                            ...
                            $Session3->flash_danger();
                                     ...
                                     <a href="contributeur.php" class="btn btn-warning">Retour à la liste</a>

                                  <?php } ?>

                                  <?php if(isset($_GET['ajout'])){ ?>
                                  <h3 class="inner-tittle">Ajouter un contributeur</h3>
                                    <div class="graph-form">
                                                        ...
                                                        if( !empty($_FILES['fichier']['name']) )
                                                        {
                                                          ...
                                                          if( in_array($videoFileType,$extensions_arr) ){
                                                            ...
                                                            if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                                              ...
                                                              // Upload
                                                              if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                                                $insertSQL = $connexion->prepare("INSERT INTO `contributeur`(`id_contri`, `nom`, `prenom`, `tel`, `email`, `passwords`, `actif`, `photo`) VALUES (:id, :nom, :prenom, :tel, :email, :pass_hash, :actif, :photo)");
                                                            ...
                                                            $insertSQL = $connexion->prepare("INSERT INTO `contributeur`(`id_contri`, `nom`, `prenom`, `tel`, `email`, `passwords`, `actif`, `couleur`) VALUES (:id, :nom, :prenom, :tel, :email, :pass_hash, :actif, :couleur)");

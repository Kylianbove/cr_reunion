                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone contributeur <a href="contributeur.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="contributeur.php?id=<?php echo $row_rs_content['id_contri']; ?>">Modif.</a>  |
                                      <a href="contributeur.php?supprimer=<?php echo $row_rs_content['id_contri']; ?>">Suppr.</a>
                                    </td>

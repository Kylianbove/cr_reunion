(function(){
  ...
  var Maps = function(elt){
    ...
    var _sources = {
      nations:'Derived from Wikipedia’s <a target="_blank" href="https://en.wikipedia.org/wiki/List_of_countries_and_territories_by_land_borders">List of countries and territories by land borders</a>',
      states:'Derived from <a target="_blank" href="https://www.statemaster.com/graph/geo_lan_bou_bor_cou-geography-land-borders">Land borders by state</a>',
      risk:'Derived from Garrett Robinson’s <a target="_blank" href="https://web.mit.edu/sp.268/www/risk.pdf">The Strategy of Risk</a>'
    }

...
(function(moment) {
	...
	if (!moment) {
		console.warn('Chart.js - Moment.js could not be found! You must include it before Chart.js to use the time scale. Download at https://momentjs.com/');
		return;
	}
	...
	var defaultConfig = {
		...
		time: {
			format: false, // false == date objects or use pattern string from https://momentjs.com/docs/#/parsing/string-format/

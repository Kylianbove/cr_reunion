...
if(isset($_GET['id'])){
$query_rs_utiles = $connexion->prepare("SELECT * FROM cr_piecesjointes WHERE id_piecejointe=?");
...
$query_rs_content = $connexion->prepare("SELECT * FROM cr_piecesjointes ORDER BY id_piecejointe ASC");
                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Piece Jointe <a href="cr_piecejointe.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="cr_piecejointe.php?id=<?php echo $row_rs_content['id_piecejointe']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="cr_piecejointe.php?supprimer=<?php echo $row_rs_content['id_piecejointe']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                    ...
                                    <?php if($row_rs_content['publier']==1){ ?><span style="display:block; width; 150px;"><i class="fa fa-check-circle" style="color: green"></i> Publié </span> <?php } ?></td>
                                      ...
                                      { ?>
                                        <td><strong><p style="color:red">!Aucun compte rendu ou compte rendu non publié/non validé</p></strong></td>
                                      <?php }else{ ?>
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM cr_piecesjointes WHERE id_piecejointe=?");
                                      $req->execute(array($_GET['supprimer']));
                                      $Session12 = new Session();
                                      $Session12->setFlash("Vous venez de supprimer une piece jointe",'error');
                                      $Session12->flash_danger();
                                      $insertGoTo = "cr_piecejointe.php?OK";
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier une Piece Jointe</h3>
                                    <div class="graph-form">
                                    ...
                                    <div class="form-group">
                                    <label for="fichier">Piece Jointe (formats autorisés: pdf, docx, doc, xlsx, xls)</label>
                                    <input type="file" id="fichier" name="fichier" value="<?php echo $row_rs_utiles['fichier']; ?>"></br>
                                    <?php

                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "pdf"){ ?>
                                    <!--  <a href="<?php /*echo $row_rs_utiles['fichier'];  */?>" target="_blank">-->
                                      <a href="./ouvrirfichier.php?dwn=./cr_fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: red"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
                                    <?php

                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "docx" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "doc"){ ?>
                                      <a href="./ouvrirfichier.php?dwn=./cr_fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: blue"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
                                    <?php

                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "xls" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "xlsx" ){ ?>
                                      <a href="./ouvrirfichier.php?dwn=./cr_fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: green"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
									<?php

                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "ppt" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "pptx" ){ ?>
                                      <a href="./ouvrirfichier.php?dwn=./cr_fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: orange"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>

									<?php

                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "jpg" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "jpeg"  || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "png" ){ ?>
                                      <a href="./ouvrirfichier.php?dwn=./cr_fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: grey"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
                                    ...
                                    <div class="form-group">
                                      <label for="publier"  style="float:left;width:200px!important;">Publier Piece Jointe</label>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <table id="myTable" class="tablesorter">
                                        <thead>
                                          <tr>
                                          <th style="width: 200px;">Couleur lien fichier</th>
                                          <th>Type fichier</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                          <tr>
                                          <td><p style="color:red">lien en rouge</p<</td>
                                          <td>fichier pdf</td>
                                        </tr>
                                        <tr>
                                          <td><p style="color:green">lien en vert</p<</td>
                                          <td>fichier excel</td>
                                        </tr>
                                        <tr>
                                          <td><p style="color:blue">lien en bleu</p<</td>
                                          <td>fichier word</td>
                                        </tr>
										<tr>
                                          <td><p style="color:orange">lien en orange</p<</td>
                                          <td>fichier powerpoint</td>
                                        </tr>
										<tr>
                                          <td><p style="color:grey">lien en gris</p<</td>
                                          <td>fichier images</td>
                                        </tr>
                                      ...
                                      if(isset($_POST['modifier']))
                                          {
                                            ...
                                            $target_dir = "cr_fichiers/piecesjointes/";
                                            ...
                                            $extensions_arr = array("pdf","docx","doc","xlsx","xls","png","jpg","jpeg","ppt","pptx");
                                            ...
                                            if( in_array($videoFileType,$extensions_arr) ){
                                              ...
                                              if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                                ...
                                                if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE cr_piecesjointes SET id_cr=:id_cr, titre=:titre, fichier=:fichier, publier=:publier WHERE id_piecejointe='".$_GET['id']."'");
                                              ...
                                              $updateSQL = $connexion->prepare("UPDATE cr_piecesjointes SET id_cr=:id_cr, titre=:titre, publier=:publier WHERE id_piecejointe='".$_GET['id']."'");
                                     ...
                                     <a href="cr_piecejointe.php" class="btn btn-warning">Retour à la liste</a>

                                      <?php } ?>

                                  <?php if(isset($_GET['ajout'])){ ?>
                                  <h3 class="inner-tittle">Ajouter une Piece Jointe</h3>
                                    <div class="graph-form">
                                    ...
                                    <div class="form-group">
                                    <label for="fichier">Piece Jointe (formats autorisés: pdf, docx, doc, xlsx, xls, ppt, pptx, png, jpg, jpeg)</label>
                                    <input type="file" id="fichier" name="fichier" required>
                                  </div></br>

                                    <div class="form-group">
                                    <label for="id_cr"  style="float:left;width:200px!important;">Compte Rendu</label>
                                    <select id="id_cr" name="id_cr">
                                    <option value="0">--</option>
                                      <?php
                                        ...
                                        if( in_array($videoFileType,$extensions_arr) ){
                                          ...
                                          if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                            ...
                                            if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                              ...
                                              $insertSQL = $connexion->prepare("INSERT INTO `cr_piecesjointes`(`id_piecejointe`, `id_cr`, `titre`, `fichier`, `publier`) VALUES (:id_piecejointe, :id_cr, :titre, :fichier, :publier)");


                                              $insertSQL -> bindParam(':id_piecejointe', $id_piecejointe);

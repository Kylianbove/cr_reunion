...
if(isset($_GET['id'])){
$query_rs_utiles = $connexion->prepare("SELECT * FROM categorie WHERE id_cat=?");
...
$query_rs_content = $connexion->prepare("SELECT * FROM categorie ORDER BY id_cat ASC");
                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Catégories <a href="categorie.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="categorie.php?id=<?php echo $row_rs_content['id_cat']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="categorie.php?supprimer=<?php echo $row_rs_content['id_cat']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM categorie WHERE id_cat=?");
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      if(isset($_POST['modifier']))
                                          {
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE categorie SET titre=:titre, publier=:publier WHERE id_cat='".$_GET['id']."'");
                                     ...
                                     <a href="categorie.php" class="btn btn-warning">Retour à la liste</a>
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <input type="hidden" name="MM_update2" value="form1" />
                                      ...
                                      if(isset($_POST['ajouter'])){
                                                        ...
                                                        $insertSQL = $connexion->prepare("INSERT INTO `categorie`(`id_cat`, `titre`, `publier`) VALUES (:id_cat, :titre, :publier)");

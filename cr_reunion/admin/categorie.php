                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Catégories <a href="categorie.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="categorie.php?id=<?php echo $row_rs_content['id_cat']; ?>">Modif.</a>  |
                                      <a href="categorie.php?supprimer=<?php echo $row_rs_content['id_cat']; ?>">Suppr.</a>
                                    </td>

                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Vidéos <a href="video.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="video.php?id=<?php echo $row_rs_content['id_video']; ?>">Modif.</a>  |
                                      <a href="video.php?supprimer=<?php echo $row_rs_content['id_video']; ?>">Suppr.</a>
                                    </td>

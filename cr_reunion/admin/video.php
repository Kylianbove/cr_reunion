...
if(isset($_GET['id'])){
$query_rs_utiles = $connexion->prepare("SELECT * FROM video WHERE id_video=?");
...
$query_rs_content = $connexion->prepare("SELECT * FROM video ORDER BY id_video ASC");
                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Vidéos <a href="video.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="video.php?id=<?php echo $row_rs_content['id_video']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="video.php?supprimer=<?php echo $row_rs_content['id_video']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM video WHERE id_video=?");
                                      $req->execute(array($_GET['supprimer']));
                                      $Session12 = new Session();
                                      $Session12->setFlash("Vous venez de supprimer une vidéo",'error');
                                      $Session12->flash_danger();
                                      $insertGoTo = "video.php?OK";
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier une Vidéo</h3>
                                    <div class="graph-form">
                                    ...
                                    <video src="./fichiers/videos/<?php echo $row_rs_utiles['fichier']; ?>" controls width='320px' height='200px'>
                                    </div></br>
                                    ...
                                    <div class="form-group">
                                      <label for="publier"  style="float:left;width:200px!important;">Publier Vidéo</label>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      if(isset($_POST['modifier']))
                                          {
                                            ...
                                            $maxsize = 2097152000; // 250Mo

                                            $name = $_POST['id_actu'] ."-". $_FILES['fichier']['name'];
                                            $target_dir = "fichiers/videos/";
                                            ...
                                            $extensions_arr = array("mp4","ogv","webm");
                                            ...
                                            if( in_array($videoFileType,$extensions_arr) ){
                                              ...
                                              if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                                ...
                                                $Session13->setFlash("Votre fichier doit faire moins de 250Mo ",'error');
                                                ...
                                                if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE video SET id_actu=:id_actu, titre=:titre, fichier=:fichier, publier=:publier WHERE id_video='".$_GET['id']."'");
                                                ...
                                                $Session14->flash_danger();
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE video SET id_actu=:id_actu, titre=:titre, publier=:publier WHERE id_video='".$_GET['id']."'");
                                     ...
                                     <a href="video.php" class="btn btn-warning">Retour à la liste</a>

                                      <?php } ?>

                                  <?php if(isset($_GET['ajout'])){ ?>
                                  <h3 class="inner-tittle">Ajouter une Vidéo</h3>
                                    <div class="graph-form">
                                        ...
                                        if( in_array($videoFileType,$extensions_arr) ){
                                          ...
                                          if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                            ...
                                            if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                              ...
                                              $insertSQL = $connexion->prepare("INSERT INTO `video`(`id_video`,`id_actu`, `titre`, `fichier`, `publier`) VALUES (:id_video, :id_actu, :titre, :fichier, :publier)");


                                              $insertSQL -> bindParam(':id_video', $id_video);

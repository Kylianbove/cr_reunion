                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Utilisateur <a href="users.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tbody>
                                    ...
                                    if(isset($_POST['filtrer']))
                                    {
                                      ...
                                      if($row_rs_content2 == null){
                                        ...
                                        $Session15->setFlash("Aucun utilisateur correspond à votre recherche",'error');
                                        $Session15->flash_danger();
                                      }
                                      do{ ?>

                                        <tr>
                                          <td><a href="users.php?id=<?php echo $row_rs_content2['id']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                            <a href="users.php?supprimer=<?php echo $row_rs_content2['id']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                          </td>
                                          <style>
                                          .cercle{
                                  ...
                                  <tr>
                                    <td><a href="users.php?id=<?php echo $row_rs_content['id']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="users.php?supprimer=<?php echo $row_rs_content['id']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                    <style>
                                    .cercle{
                                      border: 1px solid black;

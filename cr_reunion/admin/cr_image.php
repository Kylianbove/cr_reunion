...
if(isset($_GET['id'])){
$query_rs_utiles = $connexion->prepare("SELECT * FROM cr_image WHERE id_img=?");
...
$query_rs_content = $connexion->prepare("SELECT * FROM cr_image ORDER BY id_img ASC");
                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Image <a href="cr_image.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="cr_image.php?id=<?php echo $row_rs_content['id_img']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="cr_image.php?supprimer=<?php echo $row_rs_content['id_img']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                    ...
                                    <?php if($row_rs_content['publier']==1){ ?><span style="display:block; width; 150px;"><i class="fa fa-check-circle" style="color: green"></i> Publié </span> <?php } ?></td>
                                      ...
                                      { ?>
                                        <td><strong><p style="color:red">!Aucun compte rendu ou compte rendnu non publié/non validé</p></strong></td>
                                      <?php }else{ ?>
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM cr_image WHERE id_img=?");
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier une Image</h3>
                                    ...
                                    <img src="./cr_fichiers/images/<?php echo $row_rs_utiles['fichier']; ?>" controls width='320px' height='200px' >
                                    </div></br>
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            if( in_array($videoFileType,$extensions_arr) ){
                                              ...
                                              if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                                ...
                                                if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE cr_image SET id_cr=:id_cr, titre=:titre, fichier=:fichier, publier=:publier WHERE id_img='".$_GET['id']."'");
                                              ...
                                              $updateSQL = $connexion->prepare("UPDATE cr_image SET id_cr=:id_cr, titre=:titre, publier=:publier WHERE id_img='".$_GET['id']."'");
                                     ...
                                     <a href="cr_image.php" class="btn btn-warning">Retour à la liste</a>
                                        ...
                                        if( in_array($videoFileType,$extensions_arr) ){
                                          ...
                                          if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                            ...
                                            if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                              ...
                                              $insertSQL = $connexion->prepare("INSERT INTO `cr_image`(`id_img`, `id_cr`, `titre`, `fichier`, `publier`) VALUES (:id_img, :id_cr, :titre, :fichier, :publier)");

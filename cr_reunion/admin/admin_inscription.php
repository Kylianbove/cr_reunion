...
<html>
<head>
<title>Inscription des administrateur</title>
      ...
      <form action="" method="POST">
          ...
          if(isset($_POST['inscription']))
                        ...
                        if($number){
                          if($symbol){
                            if(strlen($_POST['password']) > 8){
                              ...
                              {
                                  $stmt = $connexion->prepare("INSERT INTO `adminusers`(`id_admin`, `nom`, `prenom`, `tel`, `email`, `passwords`) VALUES (:id, :nom, :prenom, :tel, :mail, :pass_hash)");
                                  ...
                                  $Session2->setFlash("Vous venez de vous inscrire en tant qu'administrateur !", 'succes');
         ...
         }else
           {
             ...
             $Session9->setFlash("Le nombre de compte administrateur autorisé est atteint(3 maximum)",'error');

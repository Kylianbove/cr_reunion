                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Audio <a href="cr_audio.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="cr_audio.php?id=<?php echo $row_rs_content['id_audio']; ?>">Modif.</a>  |
                                      <a href="cr_audio.php?supprimer=<?php echo $row_rs_content['id_audio']; ?>">Suppr.</a>
                                    </td>
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier un Audio</h3>
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <a href="cr_audio.php" class="btn btn-warning">Retour à la liste</a>

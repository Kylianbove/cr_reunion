...
if(isset($_GET['id'])){
$query_rs_utiles = $connexion->prepare("SELECT * FROM actualite WHERE id_actu=?");
...
$query_rs_content = $connexion->prepare("SELECT * FROM actualite ORDER BY id_actu ASC");
                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Actualités <a href="actualite.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                                      <div class="form-group2" style="width: 20%;">
                                        <label>Pages liées aux actualités:</label>
                                      ...
                                      <form method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <select id="publication" name="publication">
                                          ...
                                          <option value="1">Afficher actualités publiées</option>

                                          <option value="2">Afficher actualités non publiées</option>
                                        ...
                                        <select id="validation" name="validation">
                                          ...
                                          <option value="1">Afficher actualités validées</option>

                                          <option value="2">Afficher actualités non validées</option>
                                        ...
                                        <?php
                                          $select_cat = $connexion->prepare("SELECT * FROM categorie WHERE publier = 1 ORDER BY id_cat ASC");
                                          $select_cat->execute();
                              ...
                              <div class="graph-form">
                                  ...
                                  <tbody>
                                    ...
                                    if(isset($_POST['filtrer']))
                                    {
                                      ...
                                      $query_rs_content2 = $connexion->prepare("SELECT * FROM actualite WHERE $publier AND $valider AND $cat AND $affichage AND $tri ");
                                    ...
                                    ?>
                                    <tr>
                                    <td><a href="actualite.php?id=<?php echo $row_rs_content2['id_actu']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="actualite.php?supprimer=<?php echo $row_rs_content2['id_actu']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                    ...
                                    <?php if($row_rs_content2['valider']==1){ ?><span style="display:block; width; 150px;"><i class="fa fa-check-circle" style="color: green"></i> Validé </span> <?php } ?></td>
                                      ...
                                      <?php
                                      $query_rs_idcategorie = $connexion->prepare("SELECT * FROM categorie WHERE publier = 1 AND id_cat = '".$row_rs_content2['id_cat']."'");
                                ...
                                <?php }while($row_rs_content2 = $query_rs_content2->fetch());
                                    ...
                                    ?>
                                  <tr>
                                    <td><a href="actualite.php?id=<?php echo $row_rs_content['id_actu']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="actualite.php?supprimer=<?php echo $row_rs_content['id_actu']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                    ...
                                    <?php if($row_rs_content['valider']==1){ ?><span style="display:block; width; 150px;"><i class="fa fa-check-circle" style="color: green"></i> Validé </span> <?php } ?></td>
                                      ...
                                      <?php
                                      $query_rs_idcategorie = $connexion->prepare("SELECT * FROM categorie WHERE publier = 1 AND id_cat = '".$row_rs_content['id_cat']."'");
                                      $query_rs_idcategorie->execute();
                                      $row_rs_idcategorie = $query_rs_idcategorie->fetch();
                                ...
                                <?php } ?>
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM actualite WHERE id_actu=?");
                                      $req->execute(array($_GET['supprimer']));
                                      $Session12 = new Session();
                                      $Session12->setFlash("Vous venez de supprimer une actualitée",'error');
                                      $Session12->flash_danger();
                                      $insertGoTo = "actualite.php?OK";
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier une actualité</h3>
                                    <div class="graph-form">
                                    ...
                                    <select id="id_cat" name="id_cat" required>
                                      ...
                                      <?php
                                        $query_rs_cat = $connexion->prepare("SELECT * FROM categorie WHERE publier = 1 AND id_cat = '".$row_rs_utiles['id_cat']."'");
                                     ...
                                     <option value="<?php echo $row_rs_cat['id_cat']; ?>"><?php echo $row_rs_cat['titre']; ?></option>
                                      ...
                                      <?php
                                       ...
                                       ?>
                                       <?php
                                         $query_rs_cat2 = $connexion->prepare("SELECT * FROM categorie WHERE publier = 1 AND id_cat != '".$row_rs_utiles['id_cat']."'");
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                        <label for="valider"  style="float:left;width:200px!important;">Valider Actualité</label>
                                    ...
                                    <div class="form-group">
                                      <label for="publier"  style="float:left;width:200px!important;">Publier Actualité</label>
                                  ...
                                  <?php } ?>
                                      ...
                                      if(isset($_POST['modifier']))
                                          {
                                             ...
                                             if($resultat !=null || $moderateur !=null){
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE actualite SET id_cat=:id_cat, titre=:titre, accroche=:accroche, texte=:texte, valider=:valider, publier=:publier, affichage=:affichage, date_modification=NOW() WHERE id_actu='".$_GET['id']."'");
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE actualite SET id_cat=:id_cat, titre=:titre, accroche=:accroche, texte=:texte, date_modification=NOW() WHERE id_actu='".$_GET['id']."'");
                                     ...
                                     <a href="actualite.php" class="btn btn-warning">Retour à la liste</a>
                                   </form>
                                 </div>
                                      <?php } ?>

                                  <?php if(isset($_GET['ajout'])){ ?>
                                  <h3 class="inner-tittle">Ajouter une Actualité</h3>
                                    <div class="graph-form">
                                    ...
                                    <select id="id_cat" name="id_cat" required>
                                      ...
                                      <?php
                                        $query_rs_categorie = $connexion->prepare("SELECT * FROM categorie WHERE publier = 1 ORDER BY id_cat ASC");
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                        <label for="affichage"  style="float:left;width:200px!important;">Affichage Actualité</label>
                                        <select id="affichage" name="affichage" required>
                                          <option value="">--</option>
                                    ...
                                    <?php } ?>
                                     ...
                                     <input type="hidden" name="MM_update2" value="form1" />
                                      ...
                                      if(isset($_POST['ajouter'])){
                                           ...
                                           if($resultat !=null || $moderateur !=null){
                                                        $insertSQL = $connexion->prepare("INSERT INTO `actualite`(`id_actu`, `id_cat`, `titre`, `accroche`, `texte`, `valider`, `date_publication`, `publier`, `affichage`) VALUES (:id_actu, :id_cat, :titre, :accroche, :texte, :valider, NOW(), :publier, :affichage)");


                                                        $insertSQL -> bindParam(':id_actu', $id_actu);
                                            ...
                                            $insertSQL = $connexion->prepare("INSERT INTO `actualite`(`id_actu`, `id_cat`, `titre`, `accroche`, `texte`, `date_publication`) VALUES (:id_actu, :id_cat, :titre, :accroche, :texte, NOW())");

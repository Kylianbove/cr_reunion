                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Actualités <a href="actualite.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                    <tr>
                                    <td><a href="actualite.php?id=<?php echo $row_rs_content2['id_actu']; ?>">Modif.</a>  |
                                      <a href="actualite.php?supprimer=<?php echo $row_rs_content2['id_actu']; ?>">Suppr.</a>
                                    </td>
                                ...
                                <?php }while($row_rs_content2 = $query_rs_content2->fetch());
                                    ...
                                    ?>
                                  <tr>
                                    <td><a href="actualite.php?id=<?php echo $row_rs_content['id_actu']; ?>">Modif.</a>  |
                                      <a href="actualite.php?supprimer=<?php echo $row_rs_content['id_actu']; ?>">Suppr.</a>
                                    </td>

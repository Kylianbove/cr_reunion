                        ...
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                              ...
                              $count = $request->fetchColumn();
                                ?>
                                 <?php if($count < 3){ ?>
                                      <h2 class="inner-tittle">Zone admin<a href="adminusers.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="adminusers.php?id=<?php echo $row_rs_content['id_admin']; ?>">Modif.</a>  |
                                    <?php
                                    /*nombre d'administrateur */
                                      $request = $connexion->query("SELECT COUNT(id_admin) FROM adminusers");
                                      $count = $request->fetchColumn();
                                    ...
                                    <a href="adminusers.php?supprimer=<?php echo $row_rs_content['id_admin']; ?>">Suppr.</a>
                                  <?php } ?>
                                  </td>

                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Compte Rendu <a href="compte_rendu.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                    <tr>
                                    <td><a href="compte_rendu.php?id=<?php echo $row_rs_content2['id_cr']; ?>">Modif.</a>  |
                                      <a href="compte_rendu.php?supprimer=<?php echo $row_rs_content2['id_cr']; ?>">Suppr.</a>
                                    </td>
                                ...
                                <?php }while($row_rs_content2 = $query_rs_content2->fetch());
                                    ...
                                    ?>
                                  <tr>
                                    <td><a href="compte_rendu.php?id=<?php echo $row_rs_content['id_cr']; ?>">Modif.</a>  |
                                      <a href="compte_rendu.php?supprimer=<?php echo $row_rs_content['id_cr']; ?>">Suppr.</a>
                                    </td>

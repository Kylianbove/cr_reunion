                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Image <a href="image.php?ajout" class="btn btn-warning">Ajouter</a></h2>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="image.php?id=<?php echo $row_rs_content['id_img']; ?>">Modif.</a>  |
                                      <a href="image.php?supprimer=<?php echo $row_rs_content['id_img']; ?>">Suppr.</a>
                                    </td>

...
if(isset($_GET['id'])){
$query_rs_utiles = $connexion->prepare("SELECT * FROM cr_video WHERE id_video=?");
...
$query_rs_content = $connexion->prepare("SELECT * FROM cr_video ORDER BY id_video ASC");
                              ...
                              <div class="graph-form">
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM cr_video WHERE id_video=?");
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier une Vidéo</h3>
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            if( in_array($videoFileType,$extensions_arr) ){
                                              ...
                                              if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                                ...
                                                if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE cr_video SET id_cr=:id_cr, titre=:titre, fichier=:fichier, publier=:publier WHERE id_video='".$_GET['id']."'");
                                                ...
                                                $Session14->flash_danger();
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE cr_video SET id_cr=:id_cr, titre=:titre, publier=:publier WHERE id_video='".$_GET['id']."'");
                                     ...
                                     <a href="cr_video.php" class="btn btn-warning">Retour à la liste</a>
                                        ...
                                        if( in_array($videoFileType,$extensions_arr) ){
                                          ...
                                          if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                            ...
                                            if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                              ...
                                              $insertSQL = $connexion->prepare("INSERT INTO `cr_video`(`id_video`,`id_cr`, `titre`, `fichier`, `publier`) VALUES (:id_video, :id_cr, :titre, :fichier, :publier)");

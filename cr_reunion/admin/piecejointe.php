...
if(isset($_GET['id'])){
$query_rs_utiles = $connexion->prepare("SELECT * FROM piecesjointes WHERE id_piecejointe=?");
...
$query_rs_content = $connexion->prepare("SELECT * FROM piecesjointes ORDER BY id_piecejointe ASC");
                       ...
                       <!--/tabs-inner-->
                        <div class="tab-inner">
                            ...
                            <?php if((!isset($_GET['id']))&&(!isset($_GET['ajout']))){ ?>
                                      <h2 class="inner-tittle">Zone Piece Jointe <a href="piecejointe.php?ajout" class="btn btn-warning"><i class="fa fa-plus"></i> Ajouter</a></h2>
                                      ...
                                      <div class="form-group2" style="width: 20%;">
                                        ...
                                        <select id="naviguation" name="naviguation" onchange="document.location.href=this.value">
                                          ...
                                          <?php } ?>
                                          <option value="image.php">Page des Images</option>
                              ...
                              <div class="graph-form">
                                  ...
                                  <tr>
                                    <td><a href="piecejointe.php?id=<?php echo $row_rs_content['id_piecejointe']; ?>"style="color: green;"><i class="fa fa-edit"></i>Modif.</a>  |
                                      <a href="piecejointe.php?supprimer=<?php echo $row_rs_content['id_piecejointe']; ?>"style="color: red;"><i class="fa fa-trash-o"></i>Suppr.</a>
                                    </td>
                                  ...
                                  <?php
                                    if(isset($_GET['supprimer'])){
                                      ...
                                      $req = $connexion->prepare("DELETE FROM piecesjointes WHERE id_piecejointe=?");
                                  ...
                                  <?php if(isset($_GET['id'])){ ?>
                                   <h3 class="inner-tittle">Modifier une Piece Jointe</h3>
                                    ...
                                    <!--  <a href="<?php /*echo $row_rs_utiles['fichier'];  */?>" target="_blank">-->
                                      <a href="./ouvrirfichier.php?dwn=./fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: red"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
                                    <?php

                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "docx" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "doc"){ ?>
                                      <a href="./ouvrirfichier.php?dwn=./fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: blue"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
                                    <?php

                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "xls" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "xlsx" ){ ?>
                                      <a href="./ouvrirfichier.php?dwn=./fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: green"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
									<?php

                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "ppt" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "pptx" ){ ?>
                                      <a href="./ouvrirfichier.php?dwn=./fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: orange"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
									<?php
                                    ...
                                    if(pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "jpg" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "jpeg" || pathinfo($row_rs_utiles['fichier'], PATHINFO_EXTENSION) == "png" ){ ?>
                                      <a href="./ouvrirfichier.php?dwn=./fichiers/piecesjointes/<?php echo $row_rs_utiles['fichier'];  ?>"><span style="color: grey"><?php echo $row_rs_utiles['fichier']; ?></span></a>
                                    <?php } ?>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      if(isset($_POST['modifier']))
                                          {
                                            ...
                                            $target_dir = "fichiers/piecesjointes/";
                                            ...
                                            if( in_array($videoFileType,$extensions_arr) ){
                                              ...
                                              if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                                ...
                                                if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                                  ...
                                                  $updateSQL = $connexion->prepare("UPDATE piecesjointes SET id_actu=:id_actu, titre=:titre, fichier=:fichier, publier=:publier WHERE id_piecejointe='".$_GET['id']."'");
                                              ...
                                              $updateSQL = $connexion->prepare("UPDATE piecesjointes SET id_actu=:id_actu, titre=:titre, publier=:publier WHERE id_piecejointe='".$_GET['id']."'");
                                     ...
                                     <a href="piecejointe.php" class="btn btn-warning">Retour à la liste</a>
                                  ...
                                  <h3 class="inner-tittle">Ajouter une Piece Jointe</h3>
                                    ...
                                    <div class="form-group">
                                    <label for="id_actu"  style="float:left;width:200px!important;">Actualité</label>
                                    <select id="id_actu" name="id_actu">
                                    <option value="0">--</option>
                                      <?php
                                        ...
                                        if( in_array($videoFileType,$extensions_arr) ){
                                          ...
                                          if(($_FILES['fichier']['size'] >= $maxsize || $_FILES["fichier"]["size"] == 0)) {
                                            ...
                                            if(move_uploaded_file($_FILES['fichier']['tmp_name'],$target_file)){
                                              ...
                                              $insertSQL = $connexion->prepare("INSERT INTO `piecesjointes`(`id_piecejointe`, `id_actu`, `titre`, `fichier`, `publier`) VALUES (:id_piecejointe, :id_actu, :titre, :fichier, :publier)");
